export default [
    {
        ...
        description: "A website project based on the buying and selling of camper vans. "+
        "React Routing method was used to navigate between pages and Authentication Required to access sections "+
        "reserved only for logged-in users.",
    ...
    
    {
        ...
        description: "A simple quiz app project "+
        "where you have to answer five general knowledge questions.",
...

    {
        ...
        description: "A Watchlist application project where you can create " +
        "your own list of movies or TV shows to watch.",
...

    {
        ...
        description: "This project is very similar to the game of Hangman. "+
        "You have 8 lives. Each life is represented by a different programming technology. "+
        "Try not to lose your favorite!",
...

    {
        ...
        description: "A project that represents "+
        "a game where you have to win by finding the same number on all the dices. Will you be lucky quickly?",
...

    {
        ...
        description: "A simple project that generates random memes and allows " +
        "you to write what you'd like to be shown on the image. Let your creativity flow! 😆",
...

    {
        ...
        description: "A simple static project built with React depicting " +
        "my travel journal with all the destinations I would like to visit.",
